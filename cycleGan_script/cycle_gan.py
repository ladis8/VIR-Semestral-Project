...
def main(opts):
    ...
    dataloader_X, test_dataloader_X = get_emoji_loader(type=opts.X, opts=opts)
    dataloader_Y, test_dataloader_Y = get_emoji_loader(type=opts.Y, opts=opts)
...
def create_parser():
    ...
    # Data sources
    parser.add_argument('--X', type=str, default='Simulator', choices=['Simulator', 'Camera'], help='Choose the type of images for domain X.')
    parser.add_argument('--Y', type=str, default='Camera', choices=['Simulator', 'Camera'], help='Choose the type of images for domain Y.')
